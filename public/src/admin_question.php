...
<html>
	...
	<body>
        ...
        <header id="header">
				<div class="inner">
					<nav id="nav">
						<li><a href="http://localhost/knowledge_cart/admin_home.php">Home</a></li>
						<li class="active"><a href="http://localhost/knowledge_cart/admin_question.php">Questions</a></li>
					</nav>
        ...
        <!-- Banner -->
			<section id="banner">
				<div class="inner">
					<a href="http://localhost/knowledge_cart/add_questions.php"	class="btone">ADD QUESTIONS</a><br><br>
					<!--<a href="#" class="btone">SHOW QUESTIONS</a>-->						
					<br><br><br>
				</div>
		</section>
